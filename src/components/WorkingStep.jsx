...
const WorkingStep = () => {
    ...
    bg-working-img'>
            <div className='absolute inset-0 bg-heroBg bg-opacity-90'>
                {/*  */}
            </div>
            ...
            <motion.div
                ...
                font-secondary mb-4'>
                    ...
                    <p className='text-lg md:w-1/2 w-full mx-auto'>
                        ...
                        adipisicing elit. Architecto, vel ullam?
                        Distinctio suscipit repudiandae sapiente
                        officia saepe pariatur ad excepturi!
                    </p>
                </div>
                {/*  */}
            ...
            md:flex-row gap-8'>
                ...
                rounded-lg p-6 flex-1'>
                    ...
                    bg-primary text-white size-14 rounded-full
                    flex items-center justify-center'>1</div>
                        <h3 className='text-lg font-medium mt-8'
                        >Fill a form</h3>
                        <p className='my-2'>
                            Step 1 dolor sit amet consectetur,
                            adipisicing elit. Mollitia omnis alias
                            rerum! Aut, aperiam reprehenderit.
                        </p>
                    </div>
                    <div className='relative bg-white text-center
                rounded-lg p-6 flex-1'>
                ...
                rounded-lg p-6 flex-1'>
                    ...
                    flex items-center justify-center'>3</div>
                        ...
                        >Schedule</h3>
                        <p className='my-2'>
                            Step 3 dolor sit amet consectetur,
                            adipisicing elit. Mollitia omnis alias
                            rerum! Aut, aperiam reprehenderit.
                        </p>
                    </div>
