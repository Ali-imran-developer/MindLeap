...
const Navbar = () => {
    ...
    const navLinks = (
        ...
        lg:space-x-8 sm:space-x-4 space-y-2 md:space-y-0 p-4 md:p-0'>
            <li>
                <motion.a
    ...
    return (
        <header className='bg-heroBg text-white py-6 
        px-4 fixed top-0 left-0 right-0 z-10'>
            {/* container */}
            ...
            justify-between items-center h-full'>
                ...
                <div className='hidden md:block '>
                    ...
                    hover:bg-primary/90 px-4 py-2 rounded'>
                        Contact Us
                    </a>
                </div>
                {/* hamburger menu */}
            ...
            {
                isOpen && (
                    <nav className='absolute top-full left-0 w-full
                    bg-heroBg z-20 md:hidden'>
